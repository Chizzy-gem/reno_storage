...
storages = pd.read_json(f"{bucket_url}/{customers_file}")
tnxs_I = pd.read_csv(f"{bucket_url}/{tnxs_I}")
tnxs_II = pd.read_csv(f"{bucket_url}/{tnxs_II}")

# save file to local
addresses.to_csv('data/addresses.csv')
customers.to_json('data/customers.json')
storages.to_json('data/storages.json')
tnxs_I.to_csv('data/tnxs_I.csv')
tnxs_II.to_csv('data/tnxs_II.csv')